...
const Hackathons = () => (
  <section id="hackathons" className="py-20 sm:py-28 px-4 sm:px-6 max-w-6xl mx-auto">
    ...
    <div className="relative">
      {/* Timeline line */}
      <div className="absolute left-[18px] sm:left-5 top-0 bottom-0 w-px bg-gradient-to-b from-primary via-secondary to-transparent" />
      ...
      <div className="space-y-4 sm:space-y-6">
        {hackathons.map((h, i) => (
          ...
          >
            ...
            <div className="glass rounded-2xl p-4 sm:p-6 flex-1 hover:glow-primary transition-all duration-300 hover:border-primary/30 gradient-border">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-primary/15 to-secondary/15 flex items-center justify-center flex-shrink-0">
