  ...
  <section className="min-h-screen flex flex-col justify-center px-4 sm:px-6 max-w-6xl mx-auto pt-16 sm:pt-20 relative overflow-hidden bg-gradient-to-br from-background via-primary/10 to-background">
    ...
    >
      <motion.span
        ...
        className="inline-flex items-center gap-2 font-mono text-primary font-medium tracking-tight text-xs sm:text-sm mb-4 sm:mb-6 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full glass glow-primary"
      >
      ...
      <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-4 sm:mb-6 text-balance">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 sm:gap-4">
        <a
          href="#projects"
          className="w-full sm:w-auto text-center bg-gradient-to-r from-primary to-primary/80 text-primary-foreground px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:-translate-y-0.5"
        >
          View Projects
        </a>
        <a
